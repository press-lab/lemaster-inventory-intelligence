...
export const vehicles:Vehicle[]=rows.map(r=>({id:r[0],year:r[1],make:r[2],model:r[3],trim:r[4],vin:r[5],mileage:r[6],price:r[7],color:r[8],transmission:r[9],drivetrain:r[10],listingUrl:`https://www.lemastermotorcars.com/${r[11]}`,publicListing:true,cost:0,marketLow:r[7],marketMedian:r[7],marketHigh:r[7],comps:0,acquiredAt:capturedAt,source:'LemasterMotorcars.com',status:'In stock',photosComplete:false,recordsComplete:false,views:0,leads:0,qualifiedLeads:0,testDrives:0,consignment:false,remoteDeal:false,owner:'',notes:'Public listing verified from LemasterMotorcars.com.',priceHistory:[{date:'2026-09-22',price:r[7]}]}));
export const seedStore:Store={vehicles,leads:[],actions:[],lastUpdated:capturedAt,dataSource:'public-website',sourceUrl:'https://www.lemastermotorcars.com/all-inventory/index.htm',dealership:{name:'Lemaster Motorcars',phone:'480-978-4120',address:'565 E Germann Rd Ste 101, Gilbert, AZ 85297',hours:'Mon–Fri 9–6 · Sat 10–4 · Sun closed'}};
